...
//  Include idle behavior actions and conditions for registration
...
void BotController::Init(void)
{
    ...
    // Added in OPM - Phase 3 Task 3.3
    //  Register idle behavior actions and conditions with behavior tree system
    RegisterIdleActions();
    RegisterIdleConditions();
}
