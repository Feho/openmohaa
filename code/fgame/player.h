...
public:
    ...
    void EventBotHoldPosition(Event *ev);
    void EventBotStop(Event *ev);
    void EventBotStand(Event *ev);
    void EventBotCrouch(Event *ev);
    void EventBotProne(Event *ev);
    void EventBotMoveTo(Event *ev);
