...
cvar_t *g_bot_belief_decay;
cvar_t *g_bot_belief_event_weight;
cvar_t *g_bot_belief_min_patrol;
cvar_t *g_bot_belief_visit_penalty;
cvar_t *g_bot_belief_novelty_bonus;
cvar_t *g_bot_belief_score_jitter;
...
void CVAR_Init(void)
{
    ...
    g_bot_belief_decay           = gi.Cvar_Get("g_bot_belief_decay", "0.95", 0);
    ...
    g_bot_belief_visit_penalty   = gi.Cvar_Get("g_bot_belief_visit_penalty", "0.3", 0);
    g_bot_belief_novelty_bonus   = gi.Cvar_Get("g_bot_belief_novelty_bonus", "0.15", 0);
    g_bot_belief_score_jitter    = gi.Cvar_Get("g_bot_belief_score_jitter", "0.1", 0);
