...
//  Idle behavior system (curious, patrol, wander, idle)
constexpr const char *CURIOUS_TARGET               = "curiousTarget";              // Vector - Target position for curious investigation
constexpr const char *CURIOUS_START_TIME           = "curiousStartTime";           // float - When curious investigation started
...
constexpr const char *PATROL_ROUTE                 = "patrolRoute";                // std::vector<PathNode*>* - List of patrol waypoints
constexpr const char *PATROL_WAYPOINT_INDEX        = "patrolWaypointIndex";        // int - Current waypoint index
constexpr const char *PATROL_REVERSE               = "patrolReverse";              // bool - Whether patrolling in reverse (bounce mode)
constexpr const char *PATROL_MODE                  = "patrolMode";                 // std::string - "loop" or "bounce"
constexpr const char *REACHED_PATROL_WAYPOINT      = "reachedPatrolWaypoint";      // bool - Whether reached current waypoint
constexpr const char *WAYPOINT_PAUSE_TIMER         = "waypointPauseTimer";         // float - Pause timer at waypoint

constexpr const char *WANDER_TARGET                = "wanderTarget";               // Vector - Random wander target position
constexpr const char *WANDER_START_TIME            = "wanderStartTime";            // float - When wander movement started
constexpr const char *REACHED_WANDER_TARGET        = "reachedWanderTarget";        // bool - Whether reached wander target
constexpr const char *WANDER_PAUSE_TIMER           = "wanderPauseTimer";           // float - Pause timer after reaching wander target
constexpr const char *LAST_WANDER_TIME             = "lastWanderTime";             // float - Last time bot wandered

constexpr const char *ATTRACTIVE_NODE              = "attractiveNode";             // PathNode* - Current attractive node being used
constexpr const char *REACHED_ATTRACTIVE_NODE      = "reachedAttractiveNode";      // bool - Whether reached attractive node
constexpr const char *ATTRACTIVE_NODE_TIMER        = "attractiveNodeTimer";        // float - Time spent at attractive node

constexpr const char *IDLE_LOOK_TIMER              = "idleLookTimer";              // float - Timer for idle look-around behavior
