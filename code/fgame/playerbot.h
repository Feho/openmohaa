...
private:
    ...
    std::unique_ptr<AttackBotState> m_pAttackState;
    std::unique_ptr<CuriousBotState> m_pCuriousState;
    std::unique_ptr<IdleBotState> m_pIdleState;
    std::unique_ptr<GrenadeBotState> m_pGrenadeState;
    std::unique_ptr<WeaponBotState> m_pWeaponState;
